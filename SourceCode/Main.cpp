...
/*
	REMARK:  This code is in the process of being updated from my
	NWCPP presentation in May 2019 for CppCon in September 2019.
	The "2017" in the project name means that it is being compiled
	under VC 2017.  The intention is to migrate it to VS 2019, plus
	cross compile on gcc and Clang.
*/
